...
#### Step 0 : Run deltaTE on your dataset from raw counts of RIBO and RNA as well as a sample_file that can run through DESeq2. Put batch =1 if you have a batch column in your design
